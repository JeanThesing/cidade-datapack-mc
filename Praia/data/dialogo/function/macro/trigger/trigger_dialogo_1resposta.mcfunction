...
$tellraw @a[distance=..6] [{"color":"white","text":"<"},{"color":"gold","text":"$(nome)"},{"color":"white","text":">"},{"color":"white","text":"$(fala)"},{"bold":true,"click_event":{"action":"run_command","command":"/function $(function)"},"color":"#$(color)","text":"\n$(resposta)"}]
