...
execute at @e[type=villager,limit=1,name="Barbeiro Villa-Lobos"] run function dialogo:macro/fala {nome:"Barbeiro Villa Loba", fala:"O que vai ser pra hoje, chefe?"}
